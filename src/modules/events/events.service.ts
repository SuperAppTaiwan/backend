...
export enum EventType {
  ...
  RECURRING_EXPENSE_PAID = 'RECURRING_EXPENSE_PAID',
  // Goal events
  ...
  // Personal vocabulary notebook events
  VOCAB_CATEGORY_CREATED = 'VOCAB_CATEGORY_CREATED',
  VOCAB_CATEGORY_UPDATED = 'VOCAB_CATEGORY_UPDATED',
  VOCAB_CATEGORY_DELETED = 'VOCAB_CATEGORY_DELETED',
  VOCAB_WORD_CREATED = 'VOCAB_WORD_CREATED',
  VOCAB_WORD_BULK_CREATED = 'VOCAB_WORD_BULK_CREATED',
  VOCAB_WORD_UPDATED = 'VOCAB_WORD_UPDATED',
  VOCAB_WORD_DELETED = 'VOCAB_WORD_DELETED',
  VOCAB_REVIEW_SESSION_STARTED = 'VOCAB_REVIEW_SESSION_STARTED',
  VOCAB_WORD_REVIEWED = 'VOCAB_WORD_REVIEWED',
  // AI story events (Truyện AI)
  ...
  TASK_AUTO_SCHEDULED = 'TASK_AUTO_SCHEDULED',
  SCHEDULE_SERIES_UPDATED = 'SCHEDULE_SERIES_UPDATED',
  SCHEDULE_SERIES_DELETED = 'SCHEDULE_SERIES_DELETED',
  // AI events
  ...
  KNOWLEDGE_ARTICLE_DELETED = 'KNOWLEDGE_ARTICLE_DELETED',
  KNOWLEDGE_ARTICLE_VIEWED = 'KNOWLEDGE_ARTICLE_VIEWED',
  KNOWLEDGE_BOOKMARKED = 'KNOWLEDGE_BOOKMARKED',
  KNOWLEDGE_UNBOOKMARKED = 'KNOWLEDGE_UNBOOKMARKED',
}
